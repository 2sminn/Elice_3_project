...
public interface StudentPaymentStatusRepository extends JpaRepository<StudentPaymentStatus, Long> {
    Page<StudentPaymentStatus> findByBill_StatusAndUpdatedAtBetween(String status, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
    ...
    Page<StudentPaymentStatus> findByBill_StatusAndUpdatedAtBetweenAndStudent_StudentName(String status, LocalDateTime startDate, LocalDateTime endDate, String studentName, Pageable pageable);
    Page<StudentPaymentStatus> findByBill_StatusAndUpdatedAtBetweenAndStudent_PhoneNumber(String status, LocalDateTime startDate, LocalDateTime endDate, String phoneNumber, Pageable pageable);
}